...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@Override //trata os erros de parâmetros de url inválidos
	...
	@Override //Tratamento de campos não existentes no json
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, 
		...
		List<Problem.Field> problemFields = bindingResult.getFieldErrors().stream()
				.map(fieldError -> {
					String message =messageSource.getMessage(fieldError, LocaleContextHolder.getLocale()); //pega as mensagens definidas no message.properties
